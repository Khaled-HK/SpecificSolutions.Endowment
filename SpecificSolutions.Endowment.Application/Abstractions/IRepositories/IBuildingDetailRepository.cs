...
namespace SpecificSolutions.Endowment.Application.Abstractions.IRepositories
{
    public interface IBuildingDetailRepository : IRepository<BuildingDetail>
    {
        ...
        new Task<IEnumerable<BuildingDetail>> GetAllAsync(CancellationToken cancellationToken);
        new Task AddAsync(BuildingDetail buildingDetail, CancellationToken cancellationToken);
