import{u as g,S as v,P as c,U as k,E as b}from"./index-BUjByK93.js";import{T as C}from"./index-Ki0daqCR.js";import{V as n}from"./VChip-BQGw_ZUv.js";import{V as y}from"./VDivider-CIluYAUE.js";import{c as u,o as d,l as $,b as i,m as e,e as r,s,r as A,aQ as x,f as E}from"./index-DAeaaqHw.js";import{_ as B}from"./AppCardCode-DZ9V6PnC.js";import{_ as V}from"./TiptapEditor-CmSc8OEo.js";import{V as w,a as m}from"./VRow-D8cFsxOA.js";import"./VSlideGroup-BSZQ_FYf.js";import"./VAvatar-Y3erGOUU.js";import"./VImg-DouOUvLR.js";import"./vue3-perfect-scrollbar-OPxIkhCU.js";import"./VCard-BaPMxs4m.js";import"./VCardText-C4-NtoFp.js";/* empty css              */const H={class:"border pa-2 rounded custom-editor"},I={key:0,class:"d-flex flex-wrap gap-x-4 gap-y-2 mb-2"},T={__name:"DemoEditorCustomEditor",setup(p){const t=g({content:`
        <h2>
          Hi there,
        </h2>
        <p>
...
`);return(f,o)=>{const l=V;return d(),u("div",null,[i(l,{modelValue:e(t),"onUpdate:modelValue":o[0]||(o[0]=a=>x(t)?t.value=a:null),class:"border rounded basic-editor"},null,8,["modelValue"])])}}},D={},S={},J={__name:"editors",setup(p){return(t,f)=>{const o=q,l=B,a=T;return d(),E(w,null,{default:r(()=>[i(m,{cols:"12"},{default:r(()=>[i(l,{title:"Basic Editor",code:D},{default:r(()=>[i(o)]),_:1},8,["code"])]),_:1}),i(m,{cols:"12"},{default:r(()=>[i(l,{title:"Custom Editor",code:S},{default:r(()=>[i(a)]),_:1},8,["code"])]),_:1})]),_:1})}}};export{J as default};
